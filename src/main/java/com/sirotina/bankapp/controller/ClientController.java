...
public class ClientController {
    ...
    public List<Client> getAllClientsByStatus(@PathVariable ClientStatus status) throws ClientNotFoundException {
    ...
    @ResponseStatus(HttpStatus.OK)
    public Client getClientById(@PathVariable UUID id) throws ClientNotFoundException {
    ...
    public Client addNewClient(@RequestBody Client clientDto) throws ClientExistException {
